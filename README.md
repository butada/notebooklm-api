...
nlm create slides $NOTEBOOK_ID --format detailed_deck --length default --language ja --confirm

nlm create infographic $NOTEBOOK_ID --orientation landscape --detail detailed --language ja --confirm
```
